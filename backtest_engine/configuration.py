...
# Smart Trader EP1 parameter definitions
SMART_TRADER_EP1_PARAMETER_DEFINITIONS: dict[str, StrategyParameterDefinition] = {
    "calc_method": StrategyParameterDefinition(
        name="calc_method",
        kind="choice",
        value_type="str",
        description="Méthode de calcul (Geometry / Intrabar)",
        default="Geometry (Source File)",
        group="Indicator",
        choices=["Geometry (Source File)", "Intrabar (Precise)"],
    ),
    "universal_len": StrategyParameterDefinition(
        name="universal_len",
        kind="numeric",
        value_type="int",
        description="Universal Length",
        default=23,
        group="Indicator",
        default_start=10,
        default_end=50,
    ...
    "long_power_min": StrategyParameterDefinition(
        name="long_power_min",
        kind="numeric",
        value_type="float",
        description="Long Power Min",
        default=60.0,
        group="Thresholds",
        default_start=50.0,
        default_end=100.0,
    ...
    "short_power_max": StrategyParameterDefinition(
        name="short_power_max",
        kind="numeric",
        value_type="float",
        description="Short Power Max",
        default=40.0,
        group="Thresholds",
        default_start=0.0,
        default_end=50.0,
    ...
    "opp_dom_threshold": StrategyParameterDefinition(
        name="opp_dom_threshold",
        kind="numeric",
        value_type="float",
        description="Opposite Domination Threshold",
        default=80.0,
        group="Thresholds",
        default_start=50.0,
        default_end=100.0,
    ...
    "max_decay_angle": StrategyParameterDefinition(
        name="max_decay_angle",
        kind="numeric",
        value_type="float",
        description="Max Decay Angle",
        default=-15.0,
        group="Thresholds",
        default_start=-45.0,
        default_end=0.0,
    ...
    "sl_buffer_pct": StrategyParameterDefinition(
        name="sl_buffer_pct",
        kind="numeric",
        value_type="float",
        description="Stop Loss Buffer (%)",
        default=0.0,
        group="Risk",
        default_start=0.0,
        default_end=5.0,
    ...
    "tp_buffer_pct": StrategyParameterDefinition(
        name="tp_buffer_pct",
        kind="numeric",
        value_type="float",
        description="Take Profit Buffer (%)",
        default=0.0,
        group="Risk",
        default_start=0.0,
        default_end=5.0,
    ...
    "allow_long": StrategyParameterDefinition(
        name="allow_long",
        kind="bool",
        value_type="bool",
        description="Autoriser les positions Long",
        default=True,
        group="Trade Execution",
    ),
    "allow_short": StrategyParameterDefinition(
        name="allow_short",
        kind="bool",
        value_type="bool",
        description="Autoriser les positions Short",
        default=True,
        group="Trade Execution",
    ),
    **get_v3_parameters(),
...
# Dual RSI DCA Long parameter definitions
DUAL_RSI_DCA_LONG_PARAMETER_DEFINITIONS: dict[str, StrategyParameterDefinition] = {
    "entry_rsi_len": StrategyParameterDefinition(
        name="entry_rsi_len",
        kind="numeric",
        value_type="int",
        description="Longueur du RSI d'entrée",
        default=14,
        group="Indicator",
        default_start=7,
        default_end=21,
    ...
    "entry_rsi_level": StrategyParameterDefinition(
        name="entry_rsi_level",
        kind="numeric",
        value_type="float",
        description="Seuil de survente pour entrée",
        default=31.0,
        group="Indicator",
        default_start=20.0,
        default_end=45.0,
    ...
    "exit_rsi_len": StrategyParameterDefinition(
        name="exit_rsi_len",
        kind="numeric",
        value_type="int",
        description="Longueur du RSI de sortie",
        default=14,
        group="Indicator",
        default_start=7,
        default_end=21,
    ...
    "exit_rsi_level": StrategyParameterDefinition(
        name="exit_rsi_level",
        kind="numeric",
        value_type="float",
        description="Seuil de surachat pour sortie",
        default=69.0,
        group="Indicator",
        default_start=55.0,
        default_end=80.0,
    ...
    "min_profit_pct": StrategyParameterDefinition(
        name="min_profit_pct",
        kind="numeric",
        value_type="float",
        description="Profit net minimal (%)",
        default=2.4,
        group="Trade Execution",
        default_start=0.5,
        default_end=5.0,
    ...
    "ao_count": StrategyParameterDefinition(
        name="ao_count",
        kind="numeric",
        value_type="int",
        description="Nombre max d'ordres de rattrapage (AO)",
        default=5,
        group="DCA",
        default_start=2,
        default_end=10,
    ...
    "ao_step": StrategyParameterDefinition(
        name="ao_step",
        kind="numeric",
        value_type="float",
        description="Écart en % pour le 1er AO",
        default=1.3,
        group="DCA",
        default_start=0.5,
        default_end=3.0,
    ...
    "ao_step_mult": StrategyParameterDefinition(
        name="ao_step_mult",
        kind="numeric",
        value_type="float",
        description="Multiplicateur d'écart des AOs",
        default=1.3,
        group="DCA",
        default_start=1.0,
        default_end=2.0,
    ...
    "ao_size_mult": StrategyParameterDefinition(
        name="ao_size_mult",
        kind="numeric",
        value_type="float",
        description="Multiplicateur de volume des AOs",
        default=1.25,
        group="DCA",
        default_start=1.0,
        default_end=2.0,
    ...
    "base_order_size": StrategyParameterDefinition(
        name="base_order_size",
        kind="numeric",
        value_type="float",
        description="Taille de l'ordre de base (Base Order)",
        default=90.0,
        group="DCA",
    ),
    "ao_size": StrategyParameterDefinition(
        name="ao_size",
        kind="numeric",
        value_type="float",
        description="Taille du 1er ordre de rattrapage",
        default=110.0,
        group="DCA",
    ),
    **get_v3_parameters(),
...
STRATEGY_PARAMETER_DEFINITIONS = {
    ...
    "smart_trader_ep1": SMART_TRADER_EP1_PARAMETER_DEFINITIONS,
    "dual_rsi_dca_long": DUAL_RSI_DCA_LONG_PARAMETER_DEFINITIONS,
}
