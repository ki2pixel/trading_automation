...
def optimizable_parameters(strategy: str = "hma_crossover") -> dict[str, OptimizableParameter]:
    if strategy not in ("hma_crossover", "adaptive_volatility_trend", "range_filter", "3commas_bot", "pmax_explorer", "bjorgum_double_tap", "noise_boundary_intraday", "cybernetic_hilbert"):
