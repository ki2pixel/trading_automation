...
Cybernetic Hilbert (Mode Tendance - Passe 1) sur les nouveaux actifs cryptos qualifiés.
"""
...
def parse_eligible_targets(report_path: Path) -> List[Tuple[str, str]]:
    ...
    éligibles associés à la stratégie 'cybernetic_hilbert'.
    ...
    for line in section_content.splitlines():
        ...
        for col_idx in [1, 2]:
            ...
            for tf, strats_in_parentheses in matches:
                ...
                if "cybernetic_hilbert" in strats:
                    tf_clean = tf.strip()
...
def main() -> None:
    ...
    print(f"Trouvé {len(targets)} couples (symbole, timeframe) valides pour cybernetic_hilbert :")
    ...
    # Aucun override figé à ce stade (les constantes TP/SL/Phase sont définies en tant que choix de taille 1 dans la grille)
