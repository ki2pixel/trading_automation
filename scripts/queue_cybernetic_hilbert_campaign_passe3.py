...
def main() -> None:
    ...
    # Les paramètres de base sont désormais figés. On désactive 'phase_mode_enabled' (Passe 2 a échoué)
    # On active 'use_safety_stop' et on optimise 'safety_max_bars_in_trade' (0 à 50, par pas de 5).
    targets = {
        "lxsdeeur": {
            "timeframe": "60min",
    ...
    for symbol, params in targets.items():
        ...
        # Fidélité aux archives : on peut conserver 1000 trials en mode bayesian
    ...
    print(f"Succès ! {queued_count} jobs de Passe 3 ajoutés à SQLite.")
