#!/usr/bin/env python3
"""Validate the newly converted Parquet files using load_canonical_market_data."""
    ...
    for symbol in SYMBOLS:
        ...
        try:
            ...
            if "volume" not in df.columns:
                ...
                # Basic check: verify that volume has non-zero values
            ...
            if errors:
                ...
                print(f"  [OK] {symbol} passed all compatibility checks.")
                print(f"       Rows: {len(df):,}")
