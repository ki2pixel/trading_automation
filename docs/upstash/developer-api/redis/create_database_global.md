...
````yaml /devops/developer-api/openapi.yml post /redis/database
openapi: 3.0.4
info:
      ...
      properties:
        ...
        plan:
          ...
          description: >
            ...
            If omitted, the database defaults to either the pay-as-you-go or
            free plan, based on the account type.
          enum:
            - free
            - payg
            - fixed_250mb
