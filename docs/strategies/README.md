...
Les indicateurs sous-jacents (bibliothèque `backtest_engine/indicators/`) sont documentés dans le guide dédié : **[Indicateurs Techniques](../indicators/README.md)**.
...
*   **HMA Crossover** : Croisement simple de deux moyennes mobiles de Hull. [Fiche technique](./hma_crossover.md)
*   **PMax Explorer** : Croisement d'une moyenne mobile avec un stop suiveur dynamique basé sur l'ATR. [Fiche technique](./pmax_explorer.md)
*   **Adaptive Volatility Trend (AVT)** : Mesure de tendance avec adaptation automatique à la volatilité via le ratio d'efficience de Kaufman. [Fiche technique](./adaptive_volatility_trend.md)
*   **Range Filter** : Filtre de bruit identifiant les débuts de tendances majeures. [Fiche technique](./range_filter.md)
*   **MSL Friendly Trend** : Suivi de tendance calé sur les cassures de structures de marché (Market Structure Levels). [Fiche technique](./msl_trend.md)
*   **Trend Type Indicator** : Filtre macro combinant l'ADX, le DMI et l'ATR pour définir la force directionnelle. [Fiche technique](./trend_type.md)
*   **Adaptive Trend Classification** : Classification des tendances par pondération adaptative de six types de moyennes mobiles. [Fiche technique](./adaptive_trend_classification.md)
...
*   **Noise Boundary Kernel** : Version optimisée avec noyaux mathématiques (KDE) pour une estimation de densité du bruit plus précise. [Fiche technique](./noise_boundary_kernel.md)
...
*   **Smart Trader Geometric** : Analyse géométrique isotrope mesurant l'aire et les distances par rapport aux pivots sans aucun lissage temporel. [Fiche technique](./smart_trader_geometric.md)
...
*   **3Commas-Bot** : Simulateur de bot DCA classique avec croisement de moyennes et stops ATR. [Fiche technique](./3commas_bot.md)
*   **Bjorgum Double Tap** : Détection de patterns Double Top et Double Bottom avec sorties de cibles Fibonacci. [Fiche technique](./bjorgum_double_tap.md)
*   **Pivot Breakout Retest Signals** : Détection des cassures de pivots majeurs suivies d'une validation temporelle sur le retest. [Fiche technique](./pivot_retest.md)
*   **Momentum-based ZigZag** : Swing trading basé sur un oscillateur QQE lissé et un tracé de ZigZag stateful anti-lookahead. [Fiche technique](./momentum_based_zigzag.md)
